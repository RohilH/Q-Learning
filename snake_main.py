...
class Application:
    ...
    def train(self):
        ...
        # a = numpy.asarray(self.args.model_name)
        # numpy.savetxt("q_table.csv", a, delimiter=",")
        #
    def test(self):
        print("Test Phase:")
        self.agent.eval()
        ...
        print("Ne: ", self.agent.Ne, "C: ", self.agent.C, "Gamma: ", self.agent.gamma)
...
def main():
    ...
    parser.add_argument('--train_episodes', dest="train_eps", type=int, default=15000,
    ...
    parser.add_argument('--Ne', dest="Ne", type=int, default=15,
                        help='the Ne parameter used in exploration function - default 40')

    parser.add_argument('--C', dest="C", type=int, default=25,
